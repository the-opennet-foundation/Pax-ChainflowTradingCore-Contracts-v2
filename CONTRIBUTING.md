...
Thanks for your interest in contributing to v1.5.0 of the Paxeer Network Protocol! The contracts in this repo are in early stages - we are releasing the draft code now so that v1.5.0 can be built in public, with open feedback and meaningful community contribution. We expect this will be a months-long process, and we appreciate any kind of contribution, no matter how small.
